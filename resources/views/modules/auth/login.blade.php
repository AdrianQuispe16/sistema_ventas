        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('logear') }}">
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Ingree su contraseña.</div>
                    </div>
              ...
              <div class="credits">
                Desarrollado por <a target="blank" href="https://adrianquispe16.github.io/portafolio-web/">Adrian Quispe Antayhua</a>
              </div>
